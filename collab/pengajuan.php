...
<div class="card mx-5 my-5">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link" href="/collab/index.php">Usulan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/collab/bahasan.php">Pembahasan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="/collab/pengajuan.php">Pengajuan</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body mt-2 mb-3 mx-2">
        <form class="row g-3">
            ...
            <div class="col-md-6">
                <label for="inputPassword4" class="form-label">Surat Pengajuan Keluar</label>
                <input type="file" class="form-control" id="inputPassword4">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Perihal</label>
                <input type="text" class="form-control" id="inputEmail4" placeholder="Pengajuan kerja sama">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Tujuan</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="Keterangan tujuan kerja sama"></textarea>
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Status Pengajuan</label>
