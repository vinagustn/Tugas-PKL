...
<div class="card mx-5 my-5">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="/collab/pemberitahuan.php">Pemberitahuan</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body mt-2 mb-3 mx-2">
        <form class="row g-3">
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Surat Pemberitahuan</label>
                <input type="file" class="form-control" id="inputEmail4" placeholder="Pengajuan kerja sama">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Keterangan</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="Keterangan pemberitahuan mengenai kerja sama"></textarea>
            </div>
