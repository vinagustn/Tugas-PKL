...
<div class="card mx-5 my-5">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="/collab/bahasan.php">Pembahasan</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body mt-2 mb-3 mx-2">
        <form class="row g-3">
            <div class="col-12">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" placeholder="Keterangan pembahasan kerja sama"></textarea>
            </div>
