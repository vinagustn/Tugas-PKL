...
<div class="card mx-5 my-5">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="/collab/rekomendasi.php">Rekomendasi</a>
            </li>
        </ul>
    </div>
    <div class="card-body mt-2 mb-3 mx-2">
        <form class="row g-3">
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Surat Rekomendasi</label>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="Keterangan rekomendasi untuk kerja sama"></textarea>
            </div>
